...
+---------------------------------------+------------------------------------------------+
+---------------------------------------+------------------------------------------------+
\| `                                  | <p></p>                                        | | *   Можна використовувати відступи                | -  Можна використовувати відступи                         | |   *  Для створення вкладених списків               |   - Для створення  вкладених списків                         | |   *  одного типу                 |   - одного типу                           | | *  Або  вкладених списків                        | - Або  вкладених списків                                 | |   1. різних                    |   1. різних                             | |   1. типів                            |   2. types                                     |
|`                                   |                                                |
+---------------------------------------+------------------------------------------------+
+---------------------------------------+------------------------------------------------+
